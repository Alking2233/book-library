...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category_blogs: Schema.Attribute.Relation<
      'oneToMany',
      'api::categry-blog.categry-blog'
    >;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    NumOfBooks: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCategryBlogCategryBlog extends Struct.CollectionTypeSchema {
  collectionName: 'categry_blogs';
  info: {
    displayName: 'Category_blog';
    pluralName: 'categry-blogs';
    singularName: 'categry-blog';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiSliderSlider extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bg_dark: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    bg_light: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categry-blog.categry-blog': ApiCategryBlogCategryBlog;
